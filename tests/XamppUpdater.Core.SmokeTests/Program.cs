...
AssertEqual("Apache candidate status", CandidateCompatibilityStatus.Assisted.ToString(), apacheCandidate.Status.ToString());
...
AssertEqual("PHP candidate status", CandidateCompatibilityStatus.Assisted.ToString(), phpCandidate.Status.ToString());
...
AssertEqual("MariaDB candidate status", CandidateCompatibilityStatus.Assisted.ToString(), mariaDbCandidate.Status.ToString());
